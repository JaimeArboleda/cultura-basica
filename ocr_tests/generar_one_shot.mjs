...
// hoja.js para estos 6 ítems concretos.
//
// Probado A/B contra la API real (issue #31, 4 corridas por versión, gpt-5-
// mini, reasoning_effort minimal): una versión SIN esta narración (idéntica
// palabra por palabra a construirContenidoPagina, sin decir que es un
// ejemplo ni explicar qué enseña cada pregunta) falló el caso "PLUSV" ->
// "PLUSVALIA" las 3 corridas completas que se le hicieron, mientras que esta
// versión narrada lo pasó en su única corrida con este mismo contenido de
// ejemplo — señal pequeña pero consistente en la dirección de que la
// explicación explícita SÍ ayuda para este caso concreto, aunque en teoría
// un few-shot no debería necesitarla (el modelo solo tiene que responder al
// último turno de usuario, no "saber" que el anterior era un ejemplo).
// Revertido a esta versión narrada por eso, no por preferencia de diseño.
